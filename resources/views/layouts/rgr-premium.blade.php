        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
            ...
            <div>
                ...
                <ul class="grid grid-cols-2 gap-x-4 gap-y-2.5 text-sm">
                    ...
                    <li><a href="{{ route('enterprise.sponsor-portal') }}" class="text-[#F4B63D] hover:underline font-mono font-bold transition-colors">FIA Cost Cap & Sponsor Hub</a></li>
                    <li><a href="{{ route('enterprise.logistics') }}" class="text-cyan-400 hover:underline font-mono font-bold transition-colors">Logistics & Freight Hub</a></li>
                </ul>
            </div>
