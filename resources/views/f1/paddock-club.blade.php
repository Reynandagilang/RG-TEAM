...
<div class="mt-4 flex justify-center">
    <button type="button" class="btn-m1-primary text-xs" @click="openVipPassModal({{ $vipPassId ?? 'null' }})">
        Lihat VIP Pass
    </button>
</div>
                        </div>
...
<div x-data="{ open:false, html:'' }">
    ...
    <div x-show="open"
        ...
        <div class="bg-[#111315] rounded-lg overflow-hidden shadow-lg w-11/12 md:w-2/3 lg:w-1/2"
             @click.stop>
            <div class="p-4" x-html="html"></div>
            <button @click="open=false"
                    class="absolute top-2 right-2 text-[#F8FAFC] text-2xl leading-none">&times;</button>
        </div>
    </div>
</div>
            </div>
